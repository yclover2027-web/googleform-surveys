...
const CONFIG = {
    ...
    WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbxfRRiAU61_NhfHU-jtuJkvOtv1vbGftpSWTJ9AU95ywQenEXVlUg9Trc_Vq1KLLg/exec',

    // 【重要】LINE Developersで発行したLIFF ID
    LIFF_ID: '2009352624-GoqbQx4B',

    // 【重要】公式LINEの友だち追加リンク（未登録ユーザーを誘導する先）
    LINE_ADD_FRIEND_URL: 'https://line.me/R/ti/p/@742tkppk'
};
